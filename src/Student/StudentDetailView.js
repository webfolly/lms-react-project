                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-4 text-right">
                                <div className="btn-group text-center">
                                    <Link to="student-view.php?sid=1&amp;id=68"
                                          className="btn btn-success btn-sm btn-default"><i
                                        className="fa fa-eye fa-1x"></i></Link>
                                    <Link to="student-modify.php?sid=1&amp;id=68"
                                          className="btn btn-success btn-sm btn-default"><i
                                        className="fa fa-edit fa-1x"></i></Link>
                                    <Link to="student-print.php?sid=1&amp;id=68"
                                          className="btn btn-success btn-sm btn-default"><i
                                        className="fa fa-print fa-1x"></i></Link>
                                    <Link to="student-delete.php?sid=1&amp;id=68"
                                          className="btn btn-success btn-sm btn-default"><i
                                        className="fa fa-trash-o fa-1x"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
