...
export default class LecturerDetailView extends Component {
    ...
    render() {
        return this.state.isEditing ? <LecturerDetailEdit lecturer={this.state.lecturer} onChange={this.handleChange} onSubmit={this.handleSubmit}/> : <LecturerDetailsDisplay lecturer={this.state.lecturer} onClick={this.handleClick}/>
...
function LecturerDetailsDisplay(props) {
            ...
            <div className="form-group">
                <form>
                    <label>Name</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'name'} value={props.lecturer.name || ''} readOnly />
                    <label>Occupation</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'occupation'} value={props.lecturer.occupation || ''}  readOnly  />
                    <label>School</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'school'} value={props.lecturer.school || ''}  readOnly  />
                    <label>Faculty</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'faculty'} value={props.lecturer.faculty || ''}  readOnly />
                    <label>Phone</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'phone'} value={props.lecturer.phone || ''}  readOnly  />
                    <label>E-mail</label>
                    <input type="text" className="form-control" onChange={props.handleChange} name={'email'} value={props.lecturer.email || ''}  readOnly />
